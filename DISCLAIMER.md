...
agent-rigger reads from and writes to your AI coding assistant harness configuration (for example `~/.claude`), your file system, and may execute external commands on your behalf. It is your responsibility to ensure that its use is appropriate for your environment and complies with any applicable policies, regulations, or agreements. The authors are not responsible for any unintended side effects resulting from its use. Review what will be installed or removed before confirming any operation.
